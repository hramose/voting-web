         ...
         <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                           <form action="{{route('admin_party_list_search')}}" method="POST">
                    ...
                    <form action="{{route('partyCheck')}}" method="POST">
                        ...
                        <div class="form-group {{$errors->has('platform') ? 'has-error': ''}}">
                            ...
                            @if($errors->has('platform'))
                                <i class="help-block">{{$errors->first('platform')}}</i>
                            @endif
                        </div>
                        <div class="form-group {{$errors->has('objective') ? 'has-error': ''}}">
                            ...
                            @if($errors->has('objective'))
                                <i class="help-block">{{$errors->first('objective')}}</i>
                            @endif
                        </div>
